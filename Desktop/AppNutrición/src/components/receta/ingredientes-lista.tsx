                ...
                return (
                  <div key={ing.id} className="flex flex-wrap items-start gap-3 py-3">
                    ...
                    <div className="flex min-w-0 max-w-full flex-wrap items-center justify-end gap-1.5">
                      ...
                      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium tabular-nums bg-purple-100/60 text-purple-700 dark:bg-purple-500/10 dark:text-purple-400">
