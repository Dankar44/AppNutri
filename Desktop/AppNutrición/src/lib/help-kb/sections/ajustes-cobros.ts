...
export const AJUSTES_COBROS_ENTRIES: HelpEntry[] = [
  ...
  },
  {
    id: "ajc-2",
    section: "ajustes-cobros",
    question: "¿Para qué sirve Stripe Connect en AppNutri?",
    answer:
      "Stripe Connect es el sistema que permite a AppNutri generar enlaces de pago hacia tu propia cuenta de Stripe, de modo que el dinero cobrado a tus pacientes llegue directamente a ti sin pasar por intermediarios. Técnicamente, AppNutri actúa como plataforma que orquesta los pagos, pero el saldo queda siempre en tu cuenta Stripe personal o de empresa. Gracias a esta integración puedes enviar links de Checkout profesionales desde `/pagos` con apenas un clic. Sin Stripe Connect los cobros online no están disponibles.",
  ...
  },
  {
    ...
    answer:
      "El email es el que usaste al registrarte en Stripe o al iniciar sesión durante el onboarding, y sirve para que identifiques rápidamente qué cuenta tienes enlazada. El país determina las reglas fiscales, la moneda por defecto y las normativas PSD2 que se aplicarán a tus cobros. Ambos datos se recuperan desde Stripe y se muestran solo en modo lectura desde AppNutri. Si necesitas cambiar el email de la cuenta, debes hacerlo dentro de tu Stripe Dashboard.",
  ...
  },
  {
    id: "ajc-22",
    section: "ajustes-cobros",
    question: "Ya tengo cuenta en Stripe, ¿puedo enlazarla con AppNutri?",
    answer:
      "Perfectamente. Cuando pulsas \"Conectar con Stripe\" y se abre la ventana de onboarding, en lugar de crear una cuenta nueva puedes iniciar sesión con tu email y contraseña de Stripe existentes. El sistema te pedirá confirmar los permisos que AppNutri solicita y vinculará ambas partes sin que pierdas el histórico ni los ajustes de Stripe que ya tuvieras. Todo el dinero seguirá llegando a la misma cuenta bancaria y verás tus cobros tanto en AppNutri como en dashboard.stripe.com.",
