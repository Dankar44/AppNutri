...
export const AJUSTES_INTEGRACIONES_ENTRIES: HelpEntry[] = [
  ...
  },
  {
    id: "aji-2",
    section: "ajustes-integraciones",
    question: "¿Qué integraciones están disponibles actualmente en AppNutrición?",
    answer:
  ...
  },
  {
    ...
    answer:
      "En la tarjeta `Google Calendar`, dentro de `Ajustes` → `Integraciones`, pulsa el botón rojo `Desconectar`. Se abrirá un modal de confirmación que te obliga a decidir qué hacer con los eventos ya creados en tu Google (dejarlos o borrarlos). Al confirmar, AppNutrición elimina los tokens OAuth guardados y la cuenta queda desvinculada: los toggles desaparecen y vuelve a aparecer el botón `Conectar con Google`. Desde ese momento ningún cambio en la agenda se propaga a Google hasta que vuelvas a conectar.",
  ...
  },
  {
    ...
    answer:
      "`Dejar los eventos en Google` conserva intactos todos los eventos que AppNutrición había creado hasta ahora en tu calendar; simplemente deja de gestionarlos, pero siguen visibles y editables manualmente. `Borrar los eventos de Google` lanza una limpieza que elimina esos eventos de tu calendar, útil si quieres dejar Google tal como estaba antes de la integración. La opción de borrado puede tardar unos segundos si hay muchos eventos y es irreversible. Si tienes dudas, elige dejar los eventos: siempre puedes borrarlos después manualmente.",
  ...
  },
  {
    id: "aji-22",
    section: "ajustes-integraciones",
    question: "¿Puedo usar Google también para hacer login en AppNutrición?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Sí, es la configuración más recomendable. Usar el mismo email para iniciar sesión en AppNutrición y para conectar Google Calendar simplifica la gestión: un solo permiso que revisar, una sola cuenta de Google en tu ordenador y coherencia entre quién eres y qué calendar se sincroniza. No es obligatorio: puedes loguearte con un email y conectar otro email distinto en la integración, pero genera más puntos de confusión a largo plazo. Si usas cuentas distintas, apunta bien cuál es cuál para evitar desconectar la que no querías.",
  ...
  },
  {
    id: "aji-25",
    section: "ajustes-integraciones",
    question: "¿Cómo se comporta la integración si uso AppNutrición en varios dispositivos?",
    answer:
      "La conexión con Google vive en el servidor de AppNutrición asociada a tu cuenta de profesional, no a un dispositivo concreto. Eso significa que una vez conectada desde cualquier navegador (portátil, móvil, tablet), la integración queda activa para toda tu sesión independientemente de dónde accedas luego. Los eventos creados en Google Calendar aparecen en todos tus dispositivos con esa cuenta Google sincronizada (Android, iPhone, reloj, cliente de escritorio). No hace falta reconectar en cada dispositivo nuevo que uses para entrar a AppNutrición.",
