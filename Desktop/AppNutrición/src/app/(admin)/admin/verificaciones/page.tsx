...
export default async function VerificacionesPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold">Verificaciones pendientes</h1>
      ...
      {pendientes.length === 0 ? (
        <div className="bg-card rounded-xl border border-border p-12 text-center">
          ...
          <h3 className="font-medium text-lg mb-1">Todo verificado</h3>
          <p className="text-muted-foreground">No hay solicitudes pendientes de verificación</p>
        </div>
      ) : (
