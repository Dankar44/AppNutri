...
export default function TourDemoPage() {
  ...
  const planesVisibles = DEMO_PLANS.slice(0, 3);
    ...
    <div>
      ...
      <div className="flex items-start gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">{p.fechaNacimiento} ({p.edad} años)</p>
          <div className="flex items-center gap-3 mt-1.5">
            <span className="text-xs px-2 py-0.5 rounded-full bg-amber-50 dark:bg-amber-500/10 text-amber-700 dark:text-amber-400 font-medium">Paciente de ejemplo</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-6">
        ...
        <div className="space-y-6">
          ...
          <section data-tour="patient-personal-data" className="bg-card rounded-xl border border-border p-6">
            <h2 className="text-lg font-semibold mb-4 flex items-center gap-2">
              <UserRound className="w-5 h-5 text-primary" /> Datos personales
            </h2>
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div className="flex items-center gap-2"><UserRound className="w-4 h-4 text-muted-foreground" /><div><span className="text-muted-foreground text-xs">Sexo</span><p className="font-medium">{p.sexo}</p></div></div>
            </div>
          </section>
          ...
          <section data-tour="patient-medical" className="bg-card rounded-xl border border-border p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div><div className="flex items-center gap-1 mb-2"><Heart className="w-4 h-4 text-purple-500" /><span className="text-sm font-medium">Patologías</span></div><TagList tags={p.patologias} color="bg-purple-50 dark:bg-purple-500/10 text-purple-700 dark:text-purple-400" /></div>
              ...
              <div className="sm:col-span-2"><div className="flex items-center gap-1 mb-2"><Sparkles className="w-4 h-4 text-cyan-500" /><span className="text-sm font-medium">Suplementos</span></div><TagList tags={p.suplementos} color="bg-cyan-50 dark:bg-cyan-500/10 text-cyan-700 dark:text-cyan-400" /></div>
            </div>
          </section>
          ...
          <section data-tour="patient-plans" className="bg-card rounded-xl border border-border p-6">
            ...
            <span className="inline-flex items-center gap-1 text-sm text-primary font-medium mt-3 cursor-default">
              Ver todos los planes ({DEMO_PLANS.length}) <ChevronRight className="w-4 h-4" />
            </span>
          </section>
        </div>
        ...
        <div className="space-y-6">
          ...
          <section data-tour="patient-measures" className="bg-card rounded-xl border border-border p-6">
            ...
            <span className="inline-flex items-center gap-1 text-sm text-primary font-medium mt-3 cursor-default">
              Ver evolución y registrar medidas <ArrowRight className="w-4 h-4" />
            </span>
          </section>
          ...
          <section className="bg-card rounded-xl border border-border p-6">
            <h2 className="text-lg font-semibold mb-3 flex items-center gap-2">
              <StickyNote className="w-5 h-5 text-amber-500" /> Observaciones
            </h2>
          ...
          <section className="bg-card rounded-xl border border-border p-6">
            ...
            <span className="inline-flex items-center gap-1 text-sm text-primary font-medium cursor-default">
              Configurar acceso al portal <ArrowRight className="w-4 h-4" />
            </span>
          </section>
        </div>
      </div>
