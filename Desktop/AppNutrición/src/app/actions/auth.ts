...
export const getCurrentDietista = cache(async function getCurrentDietista() {
  ...
  // Al alumno no se le echa nunca (Guillermo, 1 sep 2026): al quedarse sin clases pasa a cuenta
  // normal, y eso se resuelve en el layout del panel. Aquí no hay a quién cerrarle la puerta.
